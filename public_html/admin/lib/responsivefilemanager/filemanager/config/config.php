...
$upload_dir = '/assets/static/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../assets/static/'; // relative path from filemanager folder to upload folder (with final /)
