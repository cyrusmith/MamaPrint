...
@section('content')
            ...
            @if($i % 3 === 0)
                ...
                @if(ceil($i/3) == 2)
                    <a class="hidden-xs" href="http://mama-print.ru/catalog/summerbook1"
                       ...
                       style="ddisplay: block; padding: 0 0 1em;position: relative;top: -1.5em;">
    ...
    @define $page = Input::get('page')
    @if(empty($page) || $page == 1)
        <div class="row">
            <div class="text-muted col-sm-8 col-sm-offset-2 small">
                <p>В развитии детей всё чаще и чаще стали использоваться тематические недели, тематические комплекты,
                    карточки для
                    детей. Современным мамам удобно скачать и распечатать занятие с малышом и сразу приступить к
                    обучению.
                    Тематические недели позволяют структурировано предложить достаточно большой объем знаний для ребенка
                    по
                    одной
                    теме.
                </p>

                <p>Хорошим подспорьем тематическим неделям служат тематические комплекты – сборники заданий на одну
                    тему,
                    включающие разные виды активности. Тематические недели и тематические комплекты являются новым
                    направлением в
                    домашнем обучении.</p>

                <p>Также всегда эффективны карточки для детей. Самыми первыми, пожалуй, являются карточки для
                    детей с домашними животными. Ребенок познает мир с помощью карточек для детей, расширяет кругозор и
                    словарный
                    запас. Замечательная игра на все времена лото, которую легко скачать и распечатать. Можно скачать
                    лото,
                    разрезать на задания и играть всей семьёй. Можно скачать лото на разные темы и дополнить им
                    замечательные
                    тематические недели.
                </p>
            </div>
